...
export const CHROME_DEFAULT_TOOL_NAMES = [...CHROME_CORE_TOOL_NAMES, CHROME_ENABLE_TOOL_NAME];
export const CHROME_TOOL_NAMES = [...CHROME_ATOMIC_TOOL_NAMES, CHROME_ENABLE_TOOL_NAME];
...
export const activateChromeTools = (active: ReadonlyArray<string>): Array<string> => [
  ...new Set([...withoutChromeTools(active), ...CHROME_CORE_TOOL_NAMES, CHROME_ENABLE_TOOL_NAME]),
];
