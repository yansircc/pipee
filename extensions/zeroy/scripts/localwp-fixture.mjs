...
/**
 * Rebuild a disposable LocalWP fixture from the single canonical seed.
 *
 * The callers, rather than this reusable fixture, own the permitted target
 * port. That makes every destructive entry point explicit and auditable.
 */
export const prepareLocalwpFixture = (port) => {
