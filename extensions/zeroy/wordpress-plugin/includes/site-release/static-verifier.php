...
function zeroy_runtime_verify_static_boundaries(string $theme_artifact_id, string $site_logic_artifact_id): array
{
    ...
    $theme_rules = [
        ...
        ['code' => 'theme_connector_lifecycle_forbidden', 'invariant' => 'ThemeArtifact cannot bypass the SiteDraft to SiteRelease lifecycle.', 'pattern' => '/\\b(?:zeroy_runtime_(?:create_site_draft|append_site_draft_operation|stage_site_draft_operation|replay_site_draft|discard_site_draft|(?:prepare|finalize)_site_draft_commit|finalize_site_release_browser_evidence|prepare_site_release|activate_site_release(?:_locked)?|apply_site_draft_content_operations|create_canonical|adopt_canonical|write_template_content|write_canonical_content|write_site_config_locked)|zeroy_localization_(?:write_translation_draft|write_translation_values|publish_translation|unpublish_translation))\\s*\\(/i', 'repair' => 'Stage site changes through the Agent tool surface; ThemeArtifact may only render zeroy_theme_context().'],
    ];
    $logic_rules = [
        ...
        ['code' => 'site_logic_connector_lifecycle_forbidden', 'invariant' => 'SiteLogicArtifact cannot bypass the SiteDraft to SiteRelease lifecycle.', 'pattern' => '/\\b(?:zeroy_runtime_(?:create_site_draft|append_site_draft_operation|stage_site_draft_operation|replay_site_draft|discard_site_draft|(?:prepare|finalize)_site_draft_commit|finalize_site_release_browser_evidence|prepare_site_release|activate_site_release(?:_locked)?|apply_site_draft_content_operations|create_canonical|adopt_canonical|write_template_content|write_canonical_content|write_site_config_locked)|zeroy_localization_(?:write_translation_draft|write_translation_values|publish_translation|unpublish_translation))\\s*\\(/i', 'repair' => 'Use a declared SiteLogic capability for its own facts; site content and release lifecycle change only through staged Connector operations.'],
    ];
